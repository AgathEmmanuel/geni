...
class SampleAppTemplate(Template):
    ...
    def render(self, context: RenderContext) -> list[GeneratedFile]:
        ...
        return [
            KubernetesManifest("00-namespace.yml", content=namespace_manifest),
            KubernetesManifest("01-configmap.yml", content=configmap_manifest),
            KubernetesManifest("02-serviceaccount.yml", content=service_account_manifest),
            KubernetesManifest("03-deployment.yml", content=deployment_manifest),
            KubernetesManifest("04-service.yml", content=service_manifest),
        ]
